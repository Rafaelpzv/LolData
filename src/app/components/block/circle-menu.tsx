...
const pointOnCircle = (i: number, n: number, r: number, cx = 0, cy = 0) => {
    const spacing = CONSTANTS.itemSize + 70;
    const totalWidth = (n - 1) * spacing;

    const x = cx + i * spacing - totalWidth / 2;
    const y = cy;
...
export function CircleMenu({
    ...
    return (
			<div
			  ...
			  className="relative flex items-center justify-center place-self-center overflow-visible"
			>
			            <MenuTrigger
                setIsOpen={setIsOpen}
                isOpen={isOpen}
